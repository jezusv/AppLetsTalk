...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String TAG = "MainActivity_DJATUNCAR";
    private static final int REGISTER_FORM_REQUEST = 200;
    private static final int REGISTER_MAPS_REQUEST = 300;
...
//        }
    ...
    private void showAlert() {
        ...
        dialog.setTitle("Enable Location")
                .setMessage("Su ubicación esta desactivada.\npor favor active su configuración ")
    ...
    {
        startActivityForResult(new Intent(this, MapaActivity.class), REGISTER_MAPS_REQUEST);
    }
        ...
        if (!Nammu.hasPermission(this, permissions)) {
            Nammu.askForPermission(this, permissions, new PermissionCallback() {
                ...
                public void permissionGranted() {
                    ...
                    EasyImage.openChooserWithGallery(MainActivity.this, "Seleccione una imagen…", 0);
                }

                @Override
                public void permissionRefused() {
                    Log.d(TAG, "permissionRefused");
                    Toast.makeText(MainActivity.this, "No ha concedido el permiso", Toast.LENGTH_SHORT).show();
                }
            });
            return;
        }
        ...
        EasyImage.handleActivityResult(requestCode, resultCode, data, this, new DefaultCallback() {
            ...
            public void onImagePicked(File file, EasyImage.ImageSource imageSource, int i) {
                ...
                if (lastPhoto == null || !lastPhoto.exists()) {
                    Toast.makeText(MainActivity.this, "Debes incluir una foto", Toast.LENGTH_LONG).show();
                    return;
                }
                                    ...
                                    userRef.child(currentUser.getUid())
                                            ...
                                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                ...
                                                public void onComplete(@NonNull Task<Void> task) {
                                                    if (task.isSuccessful()) {
                                                        Toast.makeText(MainActivity.this, "Imagen Guardado Correctamente", Toast.LENGTH_SHORT).show();
                                                    } else {
